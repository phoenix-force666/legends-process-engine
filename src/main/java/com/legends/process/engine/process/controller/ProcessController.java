...
import com.legends.process.engine.process.service.IProcessService;
...
public class ProcessController {
	...
	@PostMapping("/init")
	public ComResp<List<TaskDto> > init(@RequestBody PscCommonProcessRequest pscCommonProcessRequest) throws Exception{
	...
	public ComResp<List<TaskDto>>  approve(@RequestBody ComReq<PscCommonTaskRequest> comReq, HttpServletRequest request) throws Exception{
		return new ComResp.Builder().fromReq(comReq).data(processService.approve(comReq.getData(),request)).success().build();
	}

	@ApiOperation(value = "流程撤回", notes = "流程撤回")
	@RequestMapping(value = "/undo", method =  RequestMethod.POST)
	public ComResp<List<TaskDto>> undo(ComReq<PscCommonTaskRequest> comReq, HttpServletRequest request) throws Exception{
		return new ComResp.Builder().fromReq(comReq).data(processService.undo(comReq.getData(),request)).success().build();
	}
