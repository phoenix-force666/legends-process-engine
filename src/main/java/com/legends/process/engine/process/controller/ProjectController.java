...
import com.legends.process.engine.process.constant.ProjectProcessConstant;
import com.legends.process.engine.utils.StringPareseMap;
...
public class ProjectController {
    ...
    public boolean ParticipatingProject(@PathVariable String projectId, HttpEntity<String> requestEntity) {
        ...
        ProcessInstance instance = runtimeService.startProcessInstanceByKey(projectId, variables);
        if (instance == null) {
            return false;
        }else {
            return true;
    ...
    @ApiOperation(value = "获取需要审批的项目申请列表", notes = "获取需要审批的项目申请列表")
...
//        }
    ...
    */
    ...
    @ApiOperation(value = "审批项目申请", notes = "审批项目申请")
    ...
    */
    ...
    @ApiOperation(value = "获取学生需要上传额外材料的记录", notes = "获取学生需要上传额外材料的记录")
    ...
    */
    ...
    @ApiOperation(value = "上传指定项目所需的额外资料", notes = "上传指定项目所需的额外资料")
